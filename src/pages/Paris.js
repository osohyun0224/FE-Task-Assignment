...
export default function Paris() {
  ...
  useEffect(() => {
    const fetchData = async () => {
      const weatherResponse = await fetchWeather("Paris");
      if (weatherResponse) {
      ...
      const forecastResponse = await fetchForecast("Paris");
  ...
  return (
    <div className={styles.pageContainer}>
      ...
      <h1 className={styles.title}>Weather Information for Paris</h1>
